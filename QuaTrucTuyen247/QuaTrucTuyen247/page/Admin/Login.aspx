<%@ Page Title="" Language="C#" MasterPageFile="~/page/FontEnd.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="QuaTrucTuyen247.page.Admin.Login" %>
    ...
    <table style="width:1300px; height:700px; border:4px; align-items:center" border="1" align="center">
        <tr>
            <td align="center" class="auto-style1">
                <b><p style="align-items:normal; font-size:18px;color:gray; margin:auto; margin-bottom:20px">ĐĂNG NHẬP TÀI KHOẢN CỦA BẠN</p></b>
                <p style="align-items:normal; font-size:16px;color:gray; margin:auto; margin-bottom:30px">Đăng nhập tài khoản của bạn để khám phá tất
                    <br />
